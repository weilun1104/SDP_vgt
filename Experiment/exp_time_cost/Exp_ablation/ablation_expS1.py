# 专家知识逐渐解绑消融实验一 W3,L3---->L2---->W1---->L1,W2

import torch
import numpy as np
import random
from Simulation.Data.lyngspice_master.lyngspice_master.examples.ablation_S1 import *
...
file_path = ('C:/Users/icelab01/Desktop/ZhuohuaLiu_2024_BYA_jiebang/BYA_jiebang/BYA_jiebang'
             '/Knowledge_unbinding/Experiment/exp_time_cost/Exp_ablation/ResultData/Ablation_S1_seed_{}.csv').format(SEED)

# 设置计算均值，方差路径
cal_path = ("C:\\Users\\icelab01\\Desktop\\ZhuohuaLiu_2024_BYA_jiebang\\BYA_jiebang\\BYA_jiebang\\Knowledge_unbinding"
            "\\Experiment\\exp_time_cost\\Exp_ablation\\ResultData\\Ablation_S1_seed_")

# 设置保存路径
to_path =('C:\\Users\\icelab01\\Desktop\\ZhuohuaLiu_2024_BYA_jiebang\\BYA_jiebang\\BYA_jiebang\\Knowledge_unbinding'
          '\\Experiment\\exp_time_cost\\Exp_ablation\\FigureGen\\Ablation_S1_current_mean_var_strand.csv')
