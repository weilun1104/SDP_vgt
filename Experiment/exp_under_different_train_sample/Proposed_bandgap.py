...
if __name__ == "__main__":
    for i in range(1, 4):       # 设置种子 1，2，3
        ...
        # 运行优化过程
        stage_init = 20
        (best_params, best_simulation_result2, last_x, last_y, dbx, dby, ppm_num, I_num, psrr_num, last_all_x,
        ...
        # 运行优化过程
        best_params, best_simulation_result3, last_x, last_y, dbx, dby, ppm_num, I_num, psrr_num, last_all_x, all_x = (
        ...
        # 运行优化过程
        best_params, best_simulation_result4, last_x, last_y, dbx, dby, ppm_num, I_num, psrr_num, last_all_x, all_x = (
            bo.find(stage_init_num=stage_init, out_dim=3))
        initial_values = last_all_x[-1]  # 参数更新
        ...
        # 运行优化过程
        best_params, best_simulation_result5, last_x, last_y, dbx, dby, ppm_num, I_num, psrr_num, last_all_x, all_x = (
            bo.find(stage_init_num=stage_init, out_dim=3))
        initial_values = last_all_x[-1]  # 参数更新
        ...
        # 运行优化过程
        best_params, best_simulation_result6, last_x, last_y, dbx, dby, ppm_num, I_num, psrr_num, last_all_x, all_x = (
            bo.find(stage_init_num=stage_init, out_dim=3))
        ...
        file_path = ('C:/Users/icelab01/Desktop/ZhuohuaLiu_2024_BYA_jiebang/BYA_jiebang/BYA_jiebang/Knowledge_unbinding'
                     '/Experiment/exp_under_different_train_sample/exp_design_1/ourModel_v1/Proposed_bandgap_seed_{}.csv').format(SEED)
        # 实验结果计算路径
        cal_path = ("C:\\Users\\icelab01\\Desktop\\ZhuohuaLiu_2024_BYA_jiebang\\BYA_jiebang\\BYA_jiebang\\Knowledge_unbinding"
                    "\\Experiment\\exp_under_different_train_sample\\exp_design_1\\ourModel_v1\\Proposed_bandgap_seed_")
        # 均值方差计算结果保存路径
        to_path =('C:\\Users\\icelab01\\Desktop\\ZhuohuaLiu_2024_BYA_jiebang\\BYA_jiebang\\BYA_jiebang\\Knowledge_unbinding'
                  '\\Experiment\\exp_under_different_train_sample\\exp_design_1_report\\Proposed_bandgap_current_mean_var_strand.csv')
