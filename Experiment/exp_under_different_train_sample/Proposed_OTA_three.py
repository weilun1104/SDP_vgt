...
if __name__ == "__main__":
    ...
    # 运行优化过程
    best_params, best_simulation_result5, last_x, last_y, dbx, dby, gain_num, I_num, GBW_num, phase_num, last_all_x, all_x = (
        bo.find(stage_init_num=stage_init))
    initial_values = last_all_x[-1]  # 参数更新
    ...
    # 运行优化过程
    best_params, best_simulation_result6, last_x, last_y, dbx, dby, gain_num, I_num, GBW_num, phase_num, last_all_x, all_x = (
        bo.find(stage_init_num=stage_init))
    ...
    file_path = ('C:/Users/icelab01/Desktop/ZhuohuaLiu_2024_BYA_jiebang/BYA_jiebang/BYA_jiebang/Knowledge_unbinding'
                 '/Experiment/exp_under_different_train_sample/exp_design_1/ourModel_v1/Proposed_OTA_three_seed_{}.csv').format(SEED)
    # 实验结果计算路径
    cal_path = ("C:\\Users\\icelab01\\Desktop\\ZhuohuaLiu_2024_BYA_jiebang\\BYA_jiebang\\BYA_jiebang\\Knowledge_unbinding"
                "\\Experiment\\exp_under_different_train_sample\\exp_design_1\\ourModel_v1\\Proposed_OTA_three_seed_")
    # 均值方差计算结果保存路径
    to_path =('C:\\Users\\icelab01\\Desktop\\ZhuohuaLiu_2024_BYA_jiebang\\BYA_jiebang\\BYA_jiebang\\Knowledge_unbinding'
              '\\Experiment\\exp_under_different_train_sample\\exp_design_1_report\\Proposed_OTA_three_current_mean_var_strand.csv')
