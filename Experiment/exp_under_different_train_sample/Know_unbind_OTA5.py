...
# 用于保存初始满足饱和区的值
valid_x = [[2.27e-6,4.57e-6,1e-6,1.1768e-4,1.0529e-4,4.68e-5]]
...
bo = BayesianOptimization(
    ...
    mode='collect_expert_stage',                       # 设置模式，这里为分段解绑模式
...
# 设置数据保存路径
file_path = ('C:/Users/Administrator/Desktop/BYA_jiebang/Knowledge_unbinding/Experiment/exp_under_different_train_sample'
             '/exp_design_1/baseline_Model_v1/Know_unbind/Know_unbind_OTA5_seed_{}.csv').format(SEED)

# 设置计算均值，方差路径
cal_path = ("C:\\Users\\Administrator\\Desktop\\BYA_jiebang\\Knowledge_unbinding\\Experiment\\"
            "exp_under_different_train_sample\\exp_design_1\\baseline_Model_v1\\Know_unbind\\Know_unbind_OTA5_seed_")

# 设置保存路径
to_path =('C:\\Users\\Administrator\\Desktop\\BYA_jiebang\\Knowledge_unbinding\\Experiment\\exp_under_different_train_sample'
          '\\exp_design_1_report\\Know_unbind_OTA5_current_mean_var_strand.csv')
